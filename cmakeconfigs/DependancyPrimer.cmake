...
if(NOT DEPENDANCIES_LOADED)
  ...
  if(WIN32)
      ...
      set(CMAKE_INSTALL_PREFIX ${CMAKE_BINARY_DIR}/install CACHE STRING "override default windows flags" FORCE)
  else()
  ...
  if(${ENCLAVE_TARGET} STREQUAL "SGX")
    if(WIN32)
      ...
      if(DEBUG_ENCLAVE_MEMLEAK)
        set(ENCLAVE_MEMLEAK_LINK_FLAGS
          /IGNORE:4006 
          /IGNORE:4088 
          /FORCE:MULTIPLE 
          /WX:NO)
        if(DEBUG_ENCLAVE_MEMLEAK_PLACEMENT_NEW)
          set(ENCLAVE_MEMLEAK_DEFINES MEMLEAK_CHECK MEMLEAK_PLACEMENT_NEW_CHECK )
        else()
      ...
      set(SHARED_HOST_COMPILE_OPTIONS
        ${SHARED_COMPILE_OPTIONS}
        )

      set(SHARED_ENCLAVE_COMPILE_OPTIONS
        ${SHARED_COMPILE_OPTIONS}
        /d2FH4- 
        /Qspectre)
      ...
      set(SHARED_ENCLAVE_LINK_OPTIONS
        ${LINK_OPTIONS}
        )
      set(SHARED_HOST_LINK_OPTIONS
        ${LINK_OPTIONS}
        )
  ...
  elseif(${ENCLAVE_TARGET} STREQUAL "OPEN_ENCLAVE")
    ...
    set(ENCLAVE_DEFINES
        ...
        ENCLAVE_OK=OE_OK
        DISALLOW_BAD_JUMPS)
    set(ENCLAVE_LIBRARIES openenclave::oeenclave oecrypto::oecrypto
                          openenclave::oelibc openenclave::oelibcxx)
  else()
