...
if(NOT DEPENDANCIES_LOADED)
    ...
    if(UNIX)
      if(DEFINED GENERATE_SYMBOLS_INDEX)
        if(DEFINED INDEX_BINARY)
          ...
          message("post_build_strip_symbols ${target} / ${INDEX_BINARY}")
        else()
  ...
  # Calls both post_build_index_symbols and post_build_symbol_works,
  # optionally BINARY argument can be specified act upon a specific file.
  function(post_build_symbol_works target)
    cmake_parse_arguments(
      "WORK"
      ""
      "BINARY"
