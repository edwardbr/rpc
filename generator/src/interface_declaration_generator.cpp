...
namespace interface_declaration_generator
{
        ...
        std::string& output)
    {
        ...
        return rpc_generator::do_in_param_unified(r, static_cast<int>(option), false, lib, name, type, attribs, count, output);
    }
        ...
        std::string& output)
    {
        // UNIFIED: Use polymorphic renderer with print_type option  
        polymorphic_renderer r;
        return rpc_generator::do_out_param_unified(r, static_cast<int>(option), false, lib, name, type, attribs, count, output);
    }
