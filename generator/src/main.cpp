...
int main(const int argc, char* argv[])
{
    try
    {
        ...
        args::Flag no_include_rpc_headers_arg(args_parser, "no_include_rpc_headers", "do not include rpc headers", {"no_include_rpc_headers"});
        ...
        bool no_include_rpc_headers = args::get(no_include_rpc_headers_arg);
