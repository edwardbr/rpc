...
namespace rpc_generator
{
    namespace yas_generator
    {
            ...
            int& function_count)
        {
            ...
            proxy("template<>");
            proxy("{}",
                ::rpc_generator::write_proxy_send_declaration(m_ob,
            ...
            int& function_count)
        {
            ...
            proxy("template<>");
            proxy("{}",
                ::rpc_generator::write_proxy_receive_declaration(m_ob,
            ...
            int& function_count)
        {
            ...
            stub("template<>");
            stub("{}",
                ::rpc_generator::write_stub_receive_declaration(m_ob,
            ...
            int& function_count)
        {
            ...
            stub("template<>");
            stub("{}",
                ::rpc_generator::write_stub_reply_declaration(m_ob,
                    ...
                    for (auto& function : m_ob.get_functions())
                    {
                        if (function->get_entity_type() == entity_type::FUNCTION_METHOD)
                        {
                            ...
                            if (unique_signatures
                                    ...
                                    .second)
                            {
                                write_proxy_receive_method(
                                    from_host, m_ob, proxy, interface_name, function, function_count);
                            }
                        }
                    }
                }
