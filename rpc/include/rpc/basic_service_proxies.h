...
namespace rpc
{
    ...
    class local_service_proxy : public service_proxy
    {
        ...
        local_service_proxy(const char* name, const rpc::shared_ptr<child_service>& child_svc,
        ...
        static rpc::shared_ptr<local_service_proxy> create(const char* name, destination_zone parent_zone_id,
        ...
        int send(uint64_t protocol_version, encoding encoding, uint64_t tag, caller_channel_zone caller_channel_zone_id,
        ...
        {
            return parent_service_.lock()->send(protocol_version, encoding, tag, caller_channel_zone_id, caller_zone_id,
                                                destination_zone_id, object_id, interface_id, method_id, in_size_,
                                                in_buf_, out_buf_);
        }
        int try_cast(uint64_t protocol_version, destination_zone destination_zone_id, object object_id,
        ...
        uint64_t add_ref(uint64_t protocol_version, destination_channel_zone destination_channel_zone_id,
                         ...
                         add_ref_options build_out_param_channel) override
        {
            ...
            auto ret = dest->add_ref(protocol_version, destination_channel_zone_id, destination_zone_id, object_id,
        ...
        uint64_t release(uint64_t protocol_version, destination_zone destination_zone_id, object object_id,
                         caller_zone caller_zone_id) override
        {
            auto ret
                = parent_service_.lock()->release(protocol_version, destination_zone_id, object_id, caller_zone_id);
            return ret;
        }
    ...
    template<class CHILD_PTR_TYPE, class PARENT_PTR_TYPE> class local_child_service_proxy : public service_proxy
    {
        ...
        typedef std::function<int(const rpc::shared_ptr<PARENT_PTR_TYPE>&, rpc::shared_ptr<CHILD_PTR_TYPE>&,
                                  const rpc::shared_ptr<child_service>&)>
            connect_fn;
        connect_fn fn_;

        friend rpc::service;

        local_child_service_proxy(const char* name, destination_zone destination_zone_id,
                                  const rpc::shared_ptr<service>& parent_svc, connect_fn fn)
        ...
        static rpc::shared_ptr<local_child_service_proxy> create(const char* name, destination_zone destination_zone_id,
                                                                 const rpc::shared_ptr<service>& svc, connect_fn fn)
        {
        ...
        int connect(rpc::interface_descriptor input_descr, rpc::interface_descriptor& output_descr) override
        {
            ...
            return rpc::child_service::create_child_zone<rpc::local_service_proxy>(
                get_name().c_str(), get_destination_zone_id().as_zone(), get_zone_id().as_destination(), input_descr,
                output_descr, fn_, child_service_, get_operating_zone_service());
        }
        ...
        int send(uint64_t protocol_version, encoding encoding, uint64_t tag, caller_channel_zone caller_channel_zone_id,
                 ...
                 std::vector<char>& out_buf_) override
        {
            return child_service_->send(protocol_version, encoding, tag, caller_channel_zone_id, caller_zone_id,
        ...
        {
            auto ret
                = child_service_->add_ref(protocol_version, destination_channel_zone_id, destination_zone_id, object_id,
                                          caller_channel_zone_id, caller_zone_id, build_out_param_channel);
            return ret;
        }
        uint64_t release(uint64_t protocol_version, destination_zone destination_zone_id, object object_id,
