...
namespace rpc
{
    ...
    class local_service_proxy : public service_proxy
    {
        ...
        std::shared_ptr<service_proxy> clone() override {return std::shared_ptr<local_service_proxy>(new local_service_proxy(*this));}
        ...
        static std::shared_ptr<local_service_proxy> create(
            const char* name
    ...
    class local_child_service_proxy : public service_proxy
    {
        ...
        std::shared_ptr<service_proxy> clone() override {return std::shared_ptr<service_proxy>(new local_child_service_proxy(*this));}
        ...
        static std::shared_ptr<local_child_service_proxy> create(
            ...
            connect_fn fn)
        {
            return std::shared_ptr<local_child_service_proxy>(new local_child_service_proxy(name, destination_zone_id, svc, fn));
        }
