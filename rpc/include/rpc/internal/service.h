...
namespace rpc
{
    ...
    public:
        ...
        connect_to_zone(const char* name,
            ...
            Args&&... args)
        {
            RPC_ASSERT(input_interface == nullptr || !input_interface->query_casting_interface()
            ...
            Args&&... args)
        {
            ...
            {
                RPC_ASSERT(
                    !child_ptr->query_casting_interface()
