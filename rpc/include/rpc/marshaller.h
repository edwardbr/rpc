...
namespace rpc
{
    enum class add_ref_options : std::uint8_t
    {
        ...
        build_caller_route
        = 4 // when unidirectionally addreffing the caller which prepares refcounts etc in the reverse direction
    };
    ...
    public:
        ...
        virtual int send(uint64_t protocol_version, encoding encoding, uint64_t tag,
            ...
            = 0;
        virtual int try_cast(uint64_t protocol_version, destination_zone destination_zone_id, object object_id,
                             interface_ordinal interface_id)
            = 0;
        virtual uint64_t add_ref(uint64_t protocol_version, destination_channel_zone destination_channel_zone_id,
                                 destination_zone destination_zone_id, object object_id,
                                 caller_channel_zone caller_channel_zone_id, caller_zone caller_zone_id,
                                 add_ref_options build_out_param_channel)
            = 0;
        virtual uint64_t release(uint64_t protocol_version, destination_zone destination_zone_id, object object_id,
    ...
    struct interface_descriptor
    {
        ...
        {
            ar& YAS_OBJECT_NVP("interface_descriptor", ("object_id", object_id.id),
