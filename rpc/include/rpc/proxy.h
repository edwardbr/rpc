...
namespace rpc
{
    ...
    public:
        ...
        rpc::interface_proxy* get_interface_proxy() const override 
        { 
            return static_cast<interface_proxy*>(const_cast<interface_proxy_t*>(this)); 
        }   
    ...
    class service_proxy : 
        public i_marshaller,
        public std::enable_shared_from_this<service_proxy>
    {
