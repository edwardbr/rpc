...
namespace rpc
{
    ...
    struct span
    {
        ...
        span(const std::string& l) : begin((const uint8_t*)l.data()), end((const uint8_t*)(l.data() + l.size())){}

        span(const std::vector<uint8_t>& l) : begin(l.data()), end(l.data() + l.size()){}
        span(const std::vector<char>& l) : begin((const uint8_t*)l.data()), end((const uint8_t*)(l.data() + l.size())){}
        span(const std::vector<int8_t>& l) : begin((const uint8_t*)l.data()), end((const uint8_t*)(l.data() + l.size())){}

        template<size_t size>
        span(const std::array<uint8_t, size>& l) : begin(l.data()), end(l.data() + l.size()){}
        template<size_t size>
        span(const std::array<char, size>& l) : begin((const uint8_t*)l.data()), end((const uint8_t*)(l.data() + l.size())){}
        template<size_t size>
        span(const std::array<int8_t, size>& l) : begin((const uint8_t*)l.data()), end((const uint8_t*)(l.data() + l.size())){}
    };
