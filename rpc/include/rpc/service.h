...
namespace rpc
{
    ...
    public:
        ...
        interface_descriptor prepare_out_param(uint64_t protocol_version,
            caller_channel_zone caller_channel_zone_id,
            caller_zone caller_zone_id,
            rpc::proxy_base* base);
            ...
            Args&&... args)
        {
            ...
            if (input_interface)
            {
                ...
                {
                    input_descr = prepare_remote_input_interface({0},
            ...
            {
                err_code = rpc::demarshall_interface_proxy(
    ...
    public:
        ...
        static int create_child_zone(const char* name,
            zone zone_id,
            ...
            Args&&... args)
        {
            ...
            {
                auto err_code = rpc::demarshall_interface_proxy(
