...
template <class _Yty>
struct _Can_scalar_delete<_Yty, ::std::void_t<decltype(delete _STD declval<_Yty*>())>> : true_type {};

template <class _Yty, class = void>
struct _Can_array_delete : false_type {};
template <class _Yty>
struct _Can_array_delete<_Yty, ::std::void_t<decltype(delete[] _STD declval<_Yty*>())>> : true_type {};
...
template <class _Ty>
_NODISCARD bool operator==(const shared_ptr<_Ty>& _Left, ::std::nullptr_t) noexcept {
    return _Left.get() == nullptr;
}

#if _HAS_CXX20
template <class _Ty>
_NODISCARD strong_ordering operator<=>(const shared_ptr<_Ty>& _Left, ::std::nullptr_t) noexcept {
    return _Left.get() <=> static_cast<typename shared_ptr<_Ty>::element_type*>(nullptr);
}
#else // ^^^ _HAS_CXX20 / !_HAS_CXX20 vvv
template <class _Ty>
_NODISCARD bool operator==(::std::nullptr_t, const shared_ptr<_Ty>& _Right) noexcept {
...
#if !_HAS_CXX20
template <class _Ty, class _Dx>
_NODISCARD bool operator==(::std::nullptr_t, const unique_ptr<_Ty, _Dx>& _Right) noexcept {
    return !_Right;
}
...
template <class _Ty, class _Dx>
_NODISCARD bool operator<(const unique_ptr<_Ty, _Dx>& _Left, ::std::nullptr_t _Right) {
    using _Ptr = typename unique_ptr<_Ty, _Dx>::pointer;
    return ::std::less<_Ptr>{}(_Left.get(), _Right);
}

template <class _Ty, class _Dx>
_NODISCARD bool operator<(::std::nullptr_t _Left, const unique_ptr<_Ty, _Dx>& _Right) {
    using _Ptr = typename unique_ptr<_Ty, _Dx>::pointer;
...
template <class _Ty, class _Dx>
struct ::std::hash<rpc::unique_ptr<_Ty, _Dx>>
{
