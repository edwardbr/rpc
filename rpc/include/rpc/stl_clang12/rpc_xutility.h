...
#pragma once
#ifndef _RPC_XUTILITY_
#define _RPC_XUTILITY_
...
//         ::std::bool_constant<sizeof(_To) == sizeof(_From)>
//         , ::std::is_trivially_copyable<_To>::type,
//         ::std::is_trivially_copyable<_From>>::value,
//         int> = 0>
...
template <class _Ty, class... _Types>
_CONSTEXPR20 void _rpc_Construct_in_place(_Ty& _Obj, _Types&&... _Args) noexcept(
    ::std::is_nothrow_constructible<_Ty, _Types...>::value) {
#if _HAS_CXX20
