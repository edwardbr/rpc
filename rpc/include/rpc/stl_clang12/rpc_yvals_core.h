...
#pragma once
#ifndef _RPC__YVALS_CORE_H_
#define _RPC__YVALS_CORE_H_
...
// P0007R1 as_const()
// P0013R1 Logical Operator Type Traits (::std::conjunction, etc.)
...
#error _STL_WARNING_LEVEL cannot be ::std::less than 3.
#endif // _STL_WARNING_LEVEL < 3

#if _STL_WARNING_LEVEL > 4
#error _STL_WARNING_LEVEL cannot be ::std::greater than 4.
