...
namespace rpc
{
    ...
    protected:
        ...
        template<class T>
        interface_descriptor stub_bind_out_param(rpc::service& zone, uint64_t protocol_version,
    ...
    public:
        ...
        virtual int call(uint64_t protocol_version, rpc::encoding enc, caller_channel_zone caller_channel_zone_id,
                         caller_zone caller_zone_id, method method_id, size_t in_size_, const char* in_buf_,
                         std::vector<char>& out_buf_)
            = 0;
