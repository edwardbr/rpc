...
namespace local
{
    parent_transport::parent_transport(std::string name, std::shared_ptr<rpc::service> service, std::shared_ptr<child_transport> parent)
    ...
    CORO_TASK(int) parent_transport::send(uint64_t protocol_version,
        ...
        std::vector<rpc::back_channel_entry>& out_back_channel)
    {
        ...
        CO_RETURN CO_AWAIT parent->inbound_send(
    ...
    CORO_TASK(void) parent_transport::post(uint64_t protocol_version,
        rpc::encoding encoding,
        uint64_t tag,
        rpc::caller_channel_zone caller_channel_zone_id,
        rpc::caller_zone caller_zone_id,
    ...
    CORO_TASK(int) parent_transport::try_cast(
    ...
    CORO_TASK(int) parent_transport::add_ref(uint64_t protocol_version,
        ...
        std::vector<rpc::back_channel_entry>& out_back_channel)
    {
        ...
        CO_RETURN CO_AWAIT parent->inbound_add_ref(
            protocol_version,
    ...
    CORO_TASK(int) parent_transport::release(uint64_t protocol_version,
        rpc::destination_zone destination_zone_id,
        rpc::object object_id,
        rpc::caller_zone caller_zone_id,
        ...
        std::vector<rpc::back_channel_entry>& out_back_channel)
    {
        ...
        CO_RETURN CO_AWAIT parent->inbound_release(
    ...
    CORO_TASK(int) child_transport::send(uint64_t protocol_version,
        rpc::encoding encoding,
        uint64_t tag,
        rpc::caller_channel_zone caller_channel_zone_id,
        rpc::caller_zone caller_zone_id,
        ...
        std::vector<rpc::back_channel_entry>& out_back_channel)
    {
        ...
        CO_RETURN CO_AWAIT std::static_pointer_cast<rpc::i_marshaller>(child)->send(
            protocol_version, encoding, tag,
            caller_channel_zone_id, caller_zone_id, destination_zone_id,
            object_id, interface_id, method_id,
            in_size_, in_buf_, out_buf_,
    ...
    CORO_TASK(void) child_transport::post(uint64_t protocol_version,
        rpc::encoding encoding,
        uint64_t tag,
        rpc::caller_channel_zone caller_channel_zone_id,
        rpc::caller_zone caller_zone_id,
        ...
        const std::vector<rpc::back_channel_entry>& in_back_channel)
    {
        ...
        CO_AWAIT std::static_pointer_cast<rpc::i_marshaller>(child)->post(
            protocol_version, encoding, tag,
            caller_channel_zone_id, caller_zone_id, destination_zone_id,
            object_id, interface_id, method_id, options,
            in_size_, in_buf_, in_back_channel);
    ...
    CORO_TASK(int) child_transport::try_cast(
        uint64_t protocol_version,
        rpc::destination_zone destination_zone_id,
        rpc::object object_id,
        rpc::interface_ordinal interface_id,
    ...
    CORO_TASK(int) child_transport::add_ref(uint64_t protocol_version,
        rpc::destination_channel_zone destination_channel_zone_id,
        rpc::destination_zone destination_zone_id,
        rpc::object object_id,
        rpc::caller_channel_zone caller_channel_zone_id,
        ...
        std::vector<rpc::back_channel_entry>& out_back_channel)
    {
        ...
        CO_RETURN CO_AWAIT std::static_pointer_cast<rpc::i_marshaller>(child)->add_ref(
            protocol_version,
            destination_channel_zone_id, destination_zone_id, object_id,
            caller_channel_zone_id, caller_zone_id, known_direction_zone_id,
            build_out_param_channel, reference_count,
    ...
    CORO_TASK(int) child_transport::release(uint64_t protocol_version,
        rpc::destination_zone destination_zone_id,
        rpc::object object_id,
        rpc::caller_zone caller_zone_id,
        rpc::release_options options,
        ...
        std::vector<rpc::back_channel_entry>& out_back_channel)
    {
        ...
        CO_RETURN CO_AWAIT std::static_pointer_cast<rpc::i_marshaller>(child)->release(
            protocol_version, destination_zone_id, object_id,
            caller_zone_id, options, reference_count,
            in_back_channel, out_back_channel);
    }
