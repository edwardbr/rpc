...
namespace rpc
{
    ...
    public:
        ...
        virtual void on_service_try_cast(zone zone_id, destination_zone destination_zone_id, caller_zone caller_zone_id,
                                         object object_id, interface_ordinal interface_id) const
            = 0;
        virtual void on_service_add_ref(zone zone_id, destination_channel_zone destination_channel_zone_id,
            ...
            = 0;
        virtual void on_service_release(zone zone_id, destination_channel_zone destination_channel_zone_id,
                                        destination_zone destination_zone_id, object object_id,
                                        caller_zone caller_zone_id) const
            = 0;

        virtual void on_service_proxy_creation(const char* name, zone zone_id, destination_zone destination_zone_id,
                                               caller_zone caller_zone_id) const
            = 0;
        virtual void on_service_proxy_deletion(zone zone_id, destination_zone destination_zone_id,
                                               caller_zone caller_zone_id) const
            = 0;
        virtual void on_service_proxy_try_cast(zone zone_id, destination_zone destination_zone_id,
                                               caller_zone caller_zone_id, object object_id,
                                               interface_ordinal interface_id) const
            = 0;
        virtual void on_service_proxy_add_ref(zone zone_id, destination_zone destination_zone_id,
                                              destination_channel_zone destination_channel_zone_id,
                                              caller_zone caller_zone_id, object object_id,
                                              rpc::add_ref_options options) const
            = 0;
        virtual void on_service_proxy_release(zone zone_id, destination_zone destination_zone_id,
                                              destination_channel_zone destination_channel_zone_id,
                                              caller_zone caller_zone_id, object object_id) const
            = 0;
        ...
        virtual void on_service_proxy_release_external_ref(zone zone_id,
                                                           ...
                                                           caller_zone caller_zone_id, int ref_count) const
            = 0;
        ...
        virtual void on_stub_send(zone zone_id, object object_id, interface_ordinal interface_id,
                                  method method_id) const
            = 0;
        virtual void on_stub_add_ref(zone destination_zone_id, rpc::object object_id,
                                     rpc::interface_ordinal interface_id, uint64_t count,
                                     caller_zone caller_zone_id) const
            = 0;
        virtual void on_stub_release(zone destination_zone_id, rpc::object object_id,
                                     rpc::interface_ordinal interface_id, uint64_t count,
                                     caller_zone caller_zone_id) const
            = 0;

        virtual void on_object_proxy_creation(zone zone_id, destination_zone destination_zone_id, object object_id,
                                              bool add_ref_done) const
            = 0;
        virtual void on_object_proxy_deletion(zone zone_id, destination_zone destination_zone_id,
                                              object object_id) const
            = 0;

        virtual void on_interface_proxy_creation(const char* name, zone zone_id, destination_zone destination_zone_id,
                                                 object object_id, interface_ordinal interface_id) const
            = 0;
        virtual void on_interface_proxy_deletion(zone zone_id, destination_zone destination_zone_id, object object_id,
                                                 interface_ordinal interface_id) const
            = 0;
        virtual void on_interface_proxy_send(const char* method_name, zone zone_id,
                                             destination_zone destination_zone_id, object object_id,
                                             interface_ordinal interface_id, method method_id) const
            = 0;
