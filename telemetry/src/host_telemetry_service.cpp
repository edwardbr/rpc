...
namespace rpc
{
        ...
        std::for_each(services.begin(), services.end(),
                      [this](std::pair<rpc::zone, name_count> const& it)
                      {
                          fmt::print(output_, "error service zone_id {} service {} count {}\n", it.first.id,
                                     it.second.name, it.second.count);
                      });
        std::for_each(impls.begin(), impls.end(),
                      [this](std::pair<uint64_t, impl> const& it)
                      {
                          fmt::println(output_, "error implementation {} zone_id {} count {}", it.second.name,
                                       it.second.zone_id.id, it.second.count);
                      });
        std::for_each(stubs.begin(), stubs.end(),
                      [this](std::pair<zone_object, stub_info> const& it)
                      {
                          fmt::println(output_, "error stub zone_id {} object_id {} count {} address {}",
                                       it.first.zone_id.id, it.first.object_id.id, it.second.count, it.second.address);
                      });
        std::for_each(service_proxies.begin(), service_proxies.end(),
                      [this](std::pair<orig_zone, name_count> const& it)
                      {
                          fmt::print(
                              output_,
                              "error service proxy zone_id {} destination_zone_id {} caller_id {} name {} count {}\n",
                              it.first.zone_id.id, it.first.destination_zone_id.id, it.first.caller_zone_id.id,
                              it.second.name, it.second.count);
                      });
        std::for_each(object_proxies.begin(), object_proxies.end(),
                      [this](std::pair<interface_proxy_id, uint64_t> const& it)
                      {
                          fmt::print(
                              output_, "error object_proxy zone_id {} destination_zone_id {} object_id {} count {}\n",
                              it.first.zone_id.id, it.first.destination_zone_id.id, it.first.object_id.id, it.second);
                      });
        std::for_each(interface_proxies.begin(), interface_proxies.end(),
                      [this](std::pair<interface_proxy_id, name_count> const& it)
                      {
                          fmt::print(
                              output_,
                              "error interface_proxy {} zone_id {} destination_zone_id {} object_id {} count {}\n",
                              it.second.name, it.first.zone_id.id, it.first.destination_zone_id.id,
                              it.first.object_id.id, it.second.count);
                      });
    ...
    std::string service_proxy_alias(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
    ...
    void host_telemetry_service::on_service_creation(const char* name, rpc::zone zone_id) const
    {
        ...
        if(entry == services.end())
        {
            ...
            fmt::print(output_, "participant \\n\"{} zone {}\" as {} order {} #Moccasin", name, zone_id.get_val(),
                       service_alias(zone_id), service_order(zone_id));
    ...
    void host_telemetry_service::on_service_deletion(rpc::zone zone_id) const
    {
        ...
        else
        {
            ...
            {
                spdlog::error("service still being used! name {} zone_id {}", found->second.name,
                              service_alias(zone_id));
                fmt::print(output_, "deactivate {}\n", service_alias(zone_id));
    ...
    void host_telemetry_service::on_service_try_cast(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
                                                     rpc::caller_zone caller_zone_id, rpc::object object_id,
                                                     rpc::interface_ordinal interface_id) const
    {
        ...
        if(zone_id.as_destination() == destination_zone_id)
            fmt::print(output_, "{} -> {} : try_cast {}\n", service_alias(zone_id),
                       object_proxy_alias({zone_id}, destination_zone_id, object_id), interface_id.get_val());
        else
            fmt::print(output_, "{} -> {} : try_cast {}\n", service_alias(zone_id),
                       service_proxy_alias({zone_id}, destination_zone_id, caller_zone_id), interface_id.get_val());
#endif
    }

    void host_telemetry_service::on_service_add_ref(rpc::zone zone_id,
                                                    rpc::destination_channel_zone destination_channel_zone_id,
                                                    rpc::destination_zone destination_zone_id, rpc::object object_id,
                                                    rpc::caller_channel_zone caller_channel_zone_id,
                                                    rpc::caller_zone caller_zone_id, rpc::add_ref_options options) const
    {
        std::ignore = zone_id;
            ...
            if(!!(options & rpc::add_ref_options::build_caller_route))
            {
                ...
                else
                {
                    fmt::print(output_, "{} -> {} : add_ref build caller {}\n", service_alias(zone_id),
                               object_stub_alias(zone_id, object_id), get_thread_id());
                }
            }
        }
#endif
    ...
    void host_telemetry_service::on_service_proxy_creation(const char* name, rpc::zone zone_id,
    ...
    void host_telemetry_service::on_service_proxy_deletion(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
                                                           rpc::caller_zone caller_zone_id) const
    {
        std::ignore = zone_id;
        std::ignore = destination_zone_id;
        ...
        if(found == service_proxies.end())
        {
            spdlog::warn("service_proxy not found zone_id {} destination_zone_id {} caller_zone_id {}",
                         zone_id.get_val(), destination_zone_id.get_val(), caller_zone_id.get_val());
        }
        else
        {
        ...
        if(count)
        {
            spdlog::error("service still being used! name {} zone_id {} destination_zone_id {} caller_zone_id {}", name,
                          zone_id.get_val(), destination_zone_id.get_val(), caller_zone_id.get_val());
            fmt::print(output_, "deactivate {}\n", service_proxy_alias(zone_id, destination_zone_id, caller_zone_id));
    ...
    void host_telemetry_service::on_service_proxy_try_cast(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
                                                           rpc::caller_zone caller_zone_id, rpc::object object_id,
                                                           rpc::interface_ordinal interface_id) const
    {
        std::ignore = zone_id;
    ...
    void host_telemetry_service::on_service_proxy_add_ref(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
                                                          rpc::destination_channel_zone destination_channel_zone_id,
                                                          rpc::caller_zone caller_zone_id, rpc::object object_id,
                                                          rpc::add_ref_options options) const
    {
        ...
        //     fmt::print(output_, "object add_ref name with proxy added {} zone_id {} destination_zone_id {}
        ...
        {
            fmt::print(output_, "{} -> {} : dummy add_ref {} {}\n",
                       service_proxy_alias(zone_id, destination_zone_id, caller_zone_id), service_alias(dest), type,
                       get_thread_id());
        }
        else
        {
    ...
    void host_telemetry_service::on_service_proxy_release(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
                                                          rpc::destination_channel_zone destination_channel_zone_id,
                                                          rpc::caller_zone caller_zone_id, rpc::object object_id) const
    {
        std::ignore = zone_id;
        std::ignore = destination_channel_zone_id;
        std::ignore = destination_zone_id;
        ...
        if(object_id == rpc::dummy_object_id)
        {
            fmt::print(output_, "{} -> {} : dummy release {}\n",
                       service_proxy_alias(zone_id, destination_zone_id, caller_zone_id), service_alias(dest),
                       get_thread_id());
        }
        else
        {
    ...
    void host_telemetry_service::on_service_proxy_add_external_ref(
        rpc::zone zone_id, rpc::destination_channel_zone destination_channel_zone_id,
        rpc::destination_zone destination_zone_id, rpc::caller_zone caller_zone_id, int ref_count) const
    {
        std::ignore = zone_id;
        std::ignore = destination_channel_zone_id;
        std::ignore = destination_zone_id;
            ...
            if(ref_count != count)
            {
                message(level_enum::warn,
                        fmt::format("add_external_ref count does not match zone_id {} destination_zone_id {} "
                                    "caller_zone_id {} {} - {}",
                                    zone_id.id, destination_zone_id.id, caller_zone_id.id, ref_count, count)
                            .c_str());
            }
        }

        rpc::zone destination_channel_zone = {};
        if(destination_channel_zone_id == 0
           || destination_channel_zone_id == destination_zone_id.as_destination_channel())
        {
        ...
        if(entry == services.end())
        {
            ...
            fmt::print(output_, "participant \\n\"zone {}\" as {} order {} #Moccasin",
                       destination_channel_zone.get_val(), service_alias(destination_channel_zone),
    ...
    void host_telemetry_service::on_service_proxy_release_external_ref(
        rpc::zone zone_id, rpc::destination_channel_zone destination_channel_zone_id,
        rpc::destination_zone destination_zone_id, rpc::caller_zone caller_zone_id, int ref_count) const
    {
        std::ignore = zone_id;
    ...
    void host_telemetry_service::add_new_object(const char* name, uint64_t address, rpc::zone zone_id) const
    {
        ...
        fmt::print(output_, "participant \\n\"{}\" as {} order {}", name, object_alias(address),
                   object_order(zone_id, address));
    ...
    void host_telemetry_service::on_stub_creation(rpc::zone zone_id, rpc::object object_id, uint64_t address) const
    {
        ...
        fmt::print(output_, "participant \\n\"object stub\\nzone {}\\nobject {}\" as {} order {} #lime",
                   zone_id.get_val(), object_id.get_val(), object_stub_alias(zone_id, object_id),
    ...
    void host_telemetry_service::on_stub_deletion(rpc::zone zone_id, rpc::object object_id) const
    {
        ...
        else
        {
            ...
            {
                spdlog::error("stub still being used! zone_id {} object id {} address {}", zone_id.get_val(),
                              object_id.get_val(), found->second.address);
                fmt::println(output_, "deactivate {}", object_stub_alias(zone_id, object_id));
            }
            fmt::print(output_, "hnote over {} : deleted\n", object_stub_alias(zone_id, object_id));
        }
    ...
    void host_telemetry_service::on_stub_send(rpc::zone zone_id, rpc::object object_id,
    ...
    void host_telemetry_service::on_stub_add_ref(rpc::zone zone, rpc::object object_id,
                                                 rpc::interface_ordinal interface_id, uint64_t count,
                                                 rpc::caller_zone caller_zone_id) const
    {
        std::ignore = zone;
        std::ignore = interface_id;
        ...
        if(found == stubs.end())
        {
            spdlog::error("stub not found zone_id {} caller_zone_id {} object_id {}", zone.get_val(),
                          caller_zone_id.get_val(), object_id.get_val());
        }
        else
        {
            found->second.count++;
    ...
    void host_telemetry_service::on_stub_release(rpc::zone zone, rpc::object object_id,
                                                 rpc::interface_ordinal interface_id, uint64_t count,
                                                 rpc::caller_zone caller_zone_id) const
    {
        std::ignore = zone;
    ...
    void host_telemetry_service::on_object_proxy_creation(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
                                                          rpc::object object_id, bool add_ref_done) const
    {
        std::ignore = zone_id;
        std::ignore = destination_zone_id;
        std::ignore = object_id;
        ...
        fmt::print(output_,
                   ...
                   zone_id.get_val(), destination_zone_id.get_val(), object_id.get_val(),
    ...
    void host_telemetry_service::on_object_proxy_deletion(rpc::zone zone_id, rpc::destination_zone destination_zone_id,
    ...
    void host_telemetry_service::on_interface_proxy_creation(const char* name, rpc::zone zone_id,
                                                             rpc::destination_zone destination_zone_id,
...
#ifdef USE_RPC_TELEMETRY_RAII_LOGGING
        std::lock_guard g(mux);
        interface_proxies.emplace(interface_proxy_id {zone_id, destination_zone_id, object_id, interface_id},
                                  name_count {name, 1});
                                                             ...
                                                             rpc::interface_ordinal interface_id) const
    {
        ...
        {
            spdlog::warn("interface proxy not found zone_id {} destination_zone_id {} object_id {}", zone_id.get_val(),
                         destination_zone_id.get_val(), object_id.get_val());
        }
        else
        {
            auto count = --found->second.count;
            ...
            else
            {
                spdlog::error(
                    ...
                    found->second.name, zone_id.get_val(), destination_zone_id.get_val(), object_id.get_val());
                fmt::print(output_, "hnote over {} : deleted \\n {}\n",
                           object_proxy_alias(zone_id, destination_zone_id, object_id), found->second.name);
            }
        }
    ...
    void host_telemetry_service::on_interface_proxy_send(const char* method_name, rpc::zone zone_id,
                                                         rpc::destination_zone destination_zone_id,
...
#ifdef USE_RPC_TELEMETRY_RAII_LOGGING
        fmt::print(output_, "{} -> {} : {}\n", object_proxy_alias(zone_id, destination_zone_id, object_id),
                   object_stub_alias(destination_zone_id.as_zone(), object_id), method_name);
#else
        auto ob = stubs.find({destination_zone_id.as_zone(), object_id});
        if(ob != stubs.end())
        {
            fmt::println(output_, "{} -> {} : {}", service_alias(zone_id), object_alias(ob->second.address),
                         method_name);
        }
        else
        {
