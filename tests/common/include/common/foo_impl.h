...
namespace marshalled_tests
{
    ...
    public:
        ...
        CORO_TASK(error_code) create_fork_and_return_object(rpc::shared_ptr<yyy::i_example> zone_factory, const std::vector<uint64_t>& fork_zone_ids, rpc::shared_ptr<yyy::i_example>& object_from_forked_zone) override
        {
            ...
            RPC_INFO("example::create_fork_and_return_object - Zone {} creating fork chain through zone factory", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
    ...
    public:
        ...
        {
            RPC_INFO("example::cache_object_from_autonomous_zone - Zone {} autonomously creating and caching object from unknown zone", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
            ...
            RPC_INFO("Successfully cached object from autonomous zone {} in zone {}", zone_ids.back(), rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
            CO_RETURN rpc::error::OK();
        }
        ...
        {
            RPC_INFO("example::create_y_topology_fork - Zone {} creating Y-topology fork via factory zone", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
            ...
            RPC_INFO("Zone {} asking factory zone to create autonomous fork with {} zones", 
                     rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0, fork_zone_ids.size());
            ...
            RPC_INFO("Successfully created Y-topology fork - Zone {} now has object from factory's autonomous zones", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
            CO_RETURN rpc::error::OK();
        }
        
        CORO_TASK(error_code) retrieve_cached_autonomous_object(rpc::shared_ptr<yyy::i_example>& cached_object) override
        {
            RPC_INFO("example::retrieve_cached_autonomous_object - Zone {} retrieving cached autonomous object", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
            
            if (!cached_autonomous_object_) {
                RPC_ERROR("No cached autonomous object available in zone {}", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
                CO_RETURN rpc::error::ZONE_NOT_FOUND();
            }
            
            cached_object = cached_autonomous_object_;
            
            RPC_INFO("Successfully retrieved cached autonomous object in zone {}", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
        ...
        {
            RPC_INFO("example::give_host_cached_object - Zone {} giving host cached autonomous object", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
            ...
            if(!host)
            {
                RPC_ERROR("No cached host object available in zone {}", rpc::service::get_current_service() ? rpc::service::get_current_service()->get_zone_id().get_val() : 0);
