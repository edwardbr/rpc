...
namespace marshalled_tests
{
    ...
    public:
        ...
        error_code inner_create_example_in_subordinate_zone(rpc::shared_ptr<yyy::i_example>& target,
                                                            ...
                                                            const rpc::shared_ptr<yyy::i_host>& host_ptr)
        {
            ...
            auto err_code = this_service->connect_to_zone<rpc::local_child_service_proxy<yyy::i_example, yyy::i_host>>(
                "subordinate_zone", {new_zone_id}, host_ptr, target,
        ...
        error_code
        create_example_in_subordinate_zone_and_set_in_host(uint64_t new_zone_id, const std::string& name,
        ...
        error_code call_host_look_up_app(const std::string& name, rpc::shared_ptr<i_example>& app,
        ...
        error_code call_host_look_up_app_not_return_and_delete(const std::string& name,
                                                               bool run_standard_tests) override
        {
            if(!host_)
                return rpc::error::INVALID_DATA();
        ...
        error_code call_host_look_up_app_and_delete(const std::string& name, rpc::shared_ptr<i_example>& app,
                                                    bool run_standard_tests) override
        {
            if(!host_)
                return rpc::error::INVALID_DATA();
        ...
        error_code call_host_set_app(const std::string& name, const rpc::shared_ptr<i_example>& app,
                                     bool run_standard_tests) override
        {
            if(!host_)
                return rpc::error::INVALID_DATA();
        ...
        error_code send_interface_back(const rpc::shared_ptr<xxx::i_baz>& input,
