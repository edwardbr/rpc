...
namespace rpc
{
    ...
    public:
        ...
        static rpc::shared_ptr<service_proxy> create(uint64_t host_zone_id, uint64_t host_id, const rpc::shared_ptr<rpc::child_service>& operating_zone_service, const rpc::i_telemetry_service* telemetry_service);
