...
namespace rpc::spsc
{
    ...
    class service_proxy : public rpc::service_proxy
    {
        service_proxy(const char* name,
            ...
            std::shared_ptr<rpc::spsc::channel_manager> channel_manager,
        ...
        static std::shared_ptr<rpc::service_proxy> create(const char* name,
            destination_zone destination_zone_id,
            const std::shared_ptr<rpc::service>& svc,
            std::chrono::milliseconds timeout,
            queue_type* send_spsc_queue,
        ...
        static CORO_TASK(std::shared_ptr<rpc::service_proxy>) attach_remote(const char* name,
            const std::shared_ptr<rpc::service>& svc,
            destination_zone destination_zone_id,
            std::shared_ptr<rpc::spsc::channel_manager> channel_manager,
            queue_type* send_spsc_queue,
