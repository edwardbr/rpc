...
private:
    ...
    void create_local_factory()
    {
        ...
        auto child_transport = std::make_shared<local::child_transport>(factory_zone_name.c_str(),
            current_service->shared_from_this(),
            zone_id,
            local::parent_transport::bind<i_fuzz_factory, i_fuzz_factory>(zone_id,
    ...
    void create_local_cache()
    {
        ...
        auto child_transport = std::make_shared<local::child_transport>(cache_zone_name.c_str(),
            current_service->shared_from_this(),
            rpc::zone{zone_id},
            local::parent_transport::bind<i_fuzz_cache, i_fuzz_cache>(zone_id,
    ...
    void create_local_worker()
    {
        ...
        auto child_transport = std::make_shared<local::child_transport>(worker_zone_name.c_str(),
            current_service->shared_from_this(),
            rpc::zone{zone_id},
            local::parent_transport::bind<i_fuzz_worker, i_fuzz_worker>(zone_id,
...
public:
        ...
        node_type child_type, uint64_t child_zone_id, bool cache_locally, rpc::shared_ptr<i_autonomous_node>& child_node) override
    {
        ...
        try
        {
            ...
            auto child_transport = std::make_shared<local::child_transport>(child_zone_name.c_str(),
                current_service->shared_from_this(),
                zone_id,
                local::parent_transport::bind<i_autonomous_node, i_autonomous_node>(zone_id,
            ...
            auto result = current_service->connect_to_zone(child_zone_name.c_str(), child_transport, self, child_node);
...
void run_autonomous_instruction_test(int test_cycle, int instruction_count, uint64_t override_seed = 0)
{
    ...
    try
    {
...

        {
            ...
            auto child_transport = std::make_shared<local::child_transport>(zone_name.c_str(),
            ...
            root_service->connect_to_zone(
                zone_name.c_str(), child_transport, rpc::shared_ptr<i_autonomous_node>(), root_node);
