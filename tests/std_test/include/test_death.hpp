...
// Use compatibility layer that works on both Windows and Linux
#include "test_death_compat.hpp"

// For backwards compatibility, everything is available directly
// The compatibility layer handles platform-specific implementations