...
class host_telemetry_service : public rpc::i_telemetry_service
{
    ...
    struct interface_proxy_id
    {
        ...
        rpc::destination_zone zone_id = {0};
        rpc::object object_id = {0};
...
public:
    ...
    virtual void on_service_proxy_creation(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id) const override;
    virtual void on_service_proxy_deletion(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id) const override;
    virtual void on_service_proxy_try_cast(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id, rpc::interface_ordinal interface_id) const override;
    virtual void on_service_proxy_add_ref(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id, rpc::caller_zone caller_zone_id) const override;
    virtual void on_service_proxy_release(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id, rpc::caller_zone caller_zone_id) const override;  
    virtual void on_service_proxy_add_external_ref(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, int ref_count, rpc::caller_zone caller_zone_id) const override;
    virtual void on_service_proxy_release_external_ref(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, int ref_count, rpc::caller_zone caller_zone_id) const override;  
    ...
    virtual void on_stub_add_ref(rpc::destination_zone zone_id, rpc::object object_id, rpc::interface_ordinal interface_id, uint64_t count, rpc::caller_zone caller_zone_id) const override;
    virtual void on_stub_release(rpc::destination_zone zone_id, rpc::object object_id, rpc::interface_ordinal interface_id, uint64_t count, rpc::caller_zone caller_zone_id) const override;

    virtual void on_object_proxy_creation(rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id) const override;
    virtual void on_object_proxy_deletion(rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id) const override;

    virtual void on_interface_proxy_creation(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id, rpc::interface_ordinal interface_id) const override;
    virtual void on_interface_proxy_deletion(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id, rpc::interface_ordinal interface_id) const override;
    virtual void on_interface_proxy_send(const char* name, rpc::zone originating_zone_id, rpc::destination_zone zone_id, rpc::object object_id, rpc::interface_ordinal interface_id, rpc::method method_id) const override;
