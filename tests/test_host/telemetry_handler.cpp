...
extern "C"
{
    ...
    {
        if (telemetry_service)
            telemetry_service->on_service_proxy_add_ref(name, {zone_id}, {destination_zone_id}, {destination_channel_zone_id}, {caller_zone_id}, {object_id}, (rpc::add_ref_options)options);
    }
