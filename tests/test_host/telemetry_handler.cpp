...
extern "C"
{
    ...
    void on_service_add_ref_host(const char* name, uint64_t zone_id, uint64_t destination_channel_zone_id, uint64_t destination_zone_id, uint64_t object_id, uint64_t caller_channel_zone_id, uint64_t caller_zone_id)
    {
        if (telemetry_service)
